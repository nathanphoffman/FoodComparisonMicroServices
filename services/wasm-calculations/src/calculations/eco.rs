...
const PROFILES: &[VictimProfile] = &[
    VictimProfile {
        victim: PesticideVictim::Insect,
        neurons: 250_000.0,
        weight_kg: 1.2e-5,
        lifespan_years: 0.17,
    },
    VictimProfile {
        victim: PesticideVictim::Bee,
        neurons: 960_000.0,
        weight_kg: 1e-4,
        lifespan_years: 0.08,
    },
    VictimProfile {
        victim: PesticideVictim::Worm,
        neurons: 500.0,
        weight_kg: 3e-3,
        lifespan_years: 5.0,
    },
    VictimProfile {
        victim: PesticideVictim::Mammal,
        neurons: 7e7,
        weight_kg: 0.02,
        lifespan_years: 2.5,
    },
    VictimProfile {
        victim: PesticideVictim::Bird,
        neurons: 1e8,
        weight_kg: 0.05,
        lifespan_years: 3.0,
    },
    VictimProfile {
        victim: PesticideVictim::Reptile,
        neurons: 1e6,
        weight_kg: 0.05,
        lifespan_years: 4.0,
    },
...
fn get_pesticide_victim_function(
    neuron_exp: f64,
    weight_exp: f64,
    final_exp: f64,
) -> impl Fn(PesticideVictim) -> f64 {
    move |victim: PesticideVictim| {
        compute_pesticide_victim_intelligence(victim, neuron_exp, weight_exp, final_exp)
    }
}
...
pub(super) fn compute_eco_destruction(
    food: &FoodRow,
    query: &SliderQuery,
    ...
    let fn_pesticide_victim_intelligence = get_pesticide_victim_function(neuron_exp, weight_exp, final_exp);

    let insect_intel = fn_pesticide_victim_intelligence(PesticideVictim::Insect);
